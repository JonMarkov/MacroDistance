...
<!--底部信息部分组件-->
    <bottomInfoComponent></bottomInfoComponent>
<!--右侧信息部分组件-->
    <rightInfoComponent></rightInfoComponent>
    <!--    logo部分-->
    <div class="logoBox">
    ...
    <div class="optionBox">
      ...
      <div class="option_give" @click="giveLike()">
        <img src="../../../static/img/video/like_red_icon.png" v-if="likeStatus">
        <img src="../../../static/img/video/video_fa.png" v-else>
...
<script>
  // 组件调用
  import headComponent from '../common/broadcast/headComponent'
  import videoComponent from '../common/broadcast/videoComponent'
  import bottomInfoComponent from '../common/broadcast/bottomInfoComponent'
  import rightInfoComponent from '../common/broadcast/rightInfoComponent'
